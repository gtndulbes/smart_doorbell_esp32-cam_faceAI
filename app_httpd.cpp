...
#include "sdkconfig.h"
#include "camera_index.h"
extern volatile bool faceDetected;
extern volatile bool faceRecognized;
extern int8_t is_enrolling;  // pakai variabel dari file lain
    ...
    if (align_face(net_boxes, image_matrix, aligned_face) == ESP_OK)
    {
        ...
        else
        {
            ...
            if (matched_id >= 0)
            {
                ...
                rgb_printf(image_matrix, FACE_COLOR_GREEN, "Hello Tuan %u", matched_id);
            }
            else
            {
                ESP_LOGW(TAG, "No Match Found");
                rgb_print(image_matrix, FACE_COLOR_RED, "TIDAK DIKENALI!");
                matched_id = -1;
            }
        }
    }
...
static esp_err_t capture_handler(httpd_req_t *req)
{
    ...
    if (net_boxes)
    {
        ...
        if (recognition_enabled)
        {
            ...
            if (face_id >= 0)
         {
             faceRecognized = true;   // 🔓 WAJAH DIKENALI
         }
        }
#endif
